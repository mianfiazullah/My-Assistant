...
import { BillData, MonthWiseUnit, LoadItem, DetectionCase } from '../types';
...
interface ProformaProps {
  ...
  data: Partial<DetectionCase> & {
    id: string; // explicitly require id since data.id is used directly
    checkedBy: string | string[]; // DetectionCase typing has string[], this code seems to handle string | string[]
    difference: string;
    billData?: BillData;
